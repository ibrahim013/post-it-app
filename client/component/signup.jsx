...
class Signup extends React.Component {
	...
	onSubmit(e) {
		...
		this.props.userSignupRequest(this.state).then(
			...
			(err) => this.setState({ errors: err.response.data, isLoading: false, isLogedIn: true }))
	...
	<div className="form-group" >
		<button disabled={this.state.isLoading} name="login" className="btn btn-primary btn-lg lgbotton col-md-offset-4-7">
